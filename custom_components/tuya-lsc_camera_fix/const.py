...
class DPCode(StrEnum):
    ...
    TEMP_CURRENT_EXTERNAL = "temp_current_external" # Current external temperature in Celcius
    TEMP_CURRENT_EXTERNAL_F = "temp_current_external_f" # Current external temperature in Fahrenheit
